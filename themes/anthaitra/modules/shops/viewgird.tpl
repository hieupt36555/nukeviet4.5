    ...
    <div class="col-sm-12 col-md-{NUM}">
        <div class="thumbnail">
            ...
            <div class="caption text-center">
                ...
                <p class="product-hometext">{HOMETEXT}</p>
                <!-- BEGIN: product_code -->
                ...
                <!-- END: adminlink -->
                <!-- BEGIN: price -->
                <p class="price pull-left col-md-12 col-xs-12">
                    <!-- BEGIN: discounts -->
                ...
                <div class="col-md-12 col-xs-12 pull-right">
                    <a href="javascript:void(0)" id="{ROW.id}" title="{ROW.title}" onclick="cartorder(this, {GROUP_REQUIE}, '{ROW.link_pro}'); return !1;"><button type="button" class="btn btn-default dathang">{LANG.add_product}</button></a>
                </div>
                <!-- END: order -->
                <!-- BEGIN: contact -->
                <p class="price">
